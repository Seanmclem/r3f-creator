...
export const ThirdPersonCharacter = ({
  position,
  rotation,
}: {
  position: number[];
  ...
  return (
    <>
      <RigidBody
        ...
        enabledRotations={[false, false, false]} // <-------- works, middle value is the desired horizontal rotation. update a stateful value for rotation, would a ref work? would be faster? Easily animatated?, yeah try useFrame animations
      >
        ...
        <PerspectiveCamera
          ref={cameraRef}
          position={third_person_camera_position.current as any}
          rotation={third_person_camera_rotation.current as any}
          // rotation={[
